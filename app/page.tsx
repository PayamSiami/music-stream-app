...
export default function MusicApp() {
  ...
  // Compute current time - no state needed
        ...
        >
          <Link href="/search">
            <div className="relative">
              <Search
                className={`absolute left-4 top-1/2 -translate-y-1/2 transition-colors ${isSearchFocused ? "text-purple-400" : "text-gray-400"
                  }`}
                size={18}
              />
              <div
            ...
            {rooms.slice(0, 4).map((room, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <motion.div
                    className={`mt-2 text-xs flex items-center gap-1 ${room.active ? "text-green-400" : "text-purple-400"
                      }`}
                    whileHover={{ x: 3 }}
                  >
